...
public class PaymentTest {
    ...
    public void equals_allTheAsserts() {
        ...
        assertEquals(payment1.getElectroLimit1(), payment2.getElectroLimit1(), 0.01);
        assertEquals(payment1.getElectroTariff2(), payment2.getElectroTariff2(), 0.01);
        assertEquals(payment1.getElectroLimit2(), payment2.getElectroLimit2(), 0.01);
        assertEquals(payment1.getElectroTariff3(), payment2.getElectroTariff3(), 0.01);
        assertEquals(payment1.getElectroLimit3(), payment2.getElectroLimit3(), 0.01);
        ...
        assertEquals(payment1.getElectroStart(), payment2.getElectroStart(), 0.01);
        assertEquals(payment1.getElectroEnd(), payment2.getElectroEnd(), 0.01);
        assertEquals(payment1.getkWattConsumed(), payment2.getkWattConsumed(), 0.01);
        assertEquals(payment1.getWaterStart(), payment2.getWaterStart(), 0.01);
        assertEquals(payment1.getWaterEnd(), payment2.getWaterEnd(), 0.01);
        assertEquals(payment1.getM3consumed(), payment2.getM3consumed(), 0.01);
        assertEquals(payment1.getHotWaterStart(), payment2.getHotWaterStart(), 0.01);
        assertEquals(payment1.getHotWaterEnd(), payment2.getHotWaterEnd(), 0.01);
        assertEquals(payment1.getHotM3consumed(), payment2.getHotM3consumed(), 0.01);
        assertEquals(payment1.getHeatingStart(), payment2.getHeatingStart(), 0.01);
        assertEquals(payment1.getHeatingEnd(), payment2.getHeatingEnd(), 0.01);
        assertEquals(payment1.getHeatingConsumed(), payment2.getHeatingConsumed(), 0.01);
        assertEquals(payment1.getGasStart(), payment2.getGasStart(), 0.01);
        assertEquals(payment1.getGasEnd(), payment2.getGasEnd(), 0.01);
        assertEquals(payment1.getGasM3consumed(), payment2.getGasM3consumed(), 0.01);
        assertEquals(payment1.getSewageStart(), payment2.getSewageStart(), 0.01);
        assertEquals(payment1.getSewageEnd(), payment2.getSewageEnd(), 0.01);
        assertEquals(payment1.getSewageM3consumed(), payment2.getSewageM3consumed(), 0.01);
